...
enum TECcodes : TERUnderlyingType {
    ...
    tecXCHAIN_NO_CLAIM_ID = 163,
    tecXCHAIN_BAD_CLAIM_ID = 164,
    tecXCHAIN_CLAIM_NO_QUORUM = 165,
    tecXCHAIN_PROOF_UNKNOWN_KEY = 166,
    tecXCHAIN_CREATE_ACCOUNT_NONXRP_ISSUE = 167,
    tecXCHAIN_CLAIM_ACCOUNT_DST_EXISTS = 168,
    tecXCHAIN_WRONG_CHAIN = 169,
